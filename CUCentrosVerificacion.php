...
<html lang="es">
<head>
    <title>Consulta de Centros de Verificacion</title>
...
<body>
    ...
    <main class="main-content">
        <h1 class="text-center">Consulta de CentrosdeVerificacion</h1>
        <form method="GET" action="CUCentrosVerificacion.php" class="mb-4">
            ...
            <div class="form-group">
                ...
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="NoCentro" required>NoCentro
                    </label>
                </div>
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="NoLinea"> NoLinea
                    </label>
                </div>
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="Tecnico"> Tecnico
                    </label>
                </div>
                <div>
                    <label>
                ...
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="HoraEntrada"> HoraEntrada
                    </label>
                </div>
            </div>
            <div>
                    <label>
                        <input type="radio" name="Atributo" value="HoraSalida"> HoraSalida
                    </label>
                </div>
            </div>
