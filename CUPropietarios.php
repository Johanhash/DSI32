...
<body>
    ...
    <main class="main-content">
        ...
        <form method="GET" action="CUPropietarios.php" class="mb-4">
            ...
            <div class="form-group">
                ...
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="PropietarioID" required> ID Propietario
                    </label>
                </div>
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="rfc"> RFC
                    </label>
                </div>
                <div>
                    <label>
                ...
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="localidad"> Localidad
                    </label>
                </div>
                <div>
                    <label>
                        <input type="radio" name="Atributo" value="municipio"> Municipio
                    </label>
                </div>
            </div>
